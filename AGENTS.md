...
All four must pass. The baseline is **233 tests**. If your change reduces this
...
> 3. `cargo test --workspace --exclude openscript-tauri --lib --bins --tests` passes (baseline: 233 tests)
