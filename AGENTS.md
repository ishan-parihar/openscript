...
All four must pass. The baseline is **229 tests**. If your change reduces this
...
> 3. `cargo test --workspace --exclude openscript-tauri --lib --bins --tests` passes (baseline: 229 tests)
