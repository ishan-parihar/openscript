...
All four must pass. The baseline is **232 tests**. If your change reduces this
...
> 3. `cargo test --workspace --exclude openscript-tauri --lib --bins --tests` passes (baseline: 232 tests)
