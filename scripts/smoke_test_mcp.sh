...
# 4a. tools/list — verify all 111 tools are registered
...
echo "Tool count: $TOOL_COUNT (expected 111)"
if [ "$TOOL_COUNT" -ne 111 ]; then
    echo "  ✗ Expected 111 tools, got $TOOL_COUNT"
    exit 1
fi
