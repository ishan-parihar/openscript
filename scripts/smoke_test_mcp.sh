...
# 4a. tools/list — verify all 109 tools are registered
...
echo "Tool count: $TOOL_COUNT (expected 109)"
if [ "$TOOL_COUNT" -ne 109 ]; then
    echo "  ✗ Expected 109 tools, got $TOOL_COUNT"
    exit 1
fi
