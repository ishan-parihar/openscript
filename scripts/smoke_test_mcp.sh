...
# 4a. tools/list — verify all 112 tools are registered
...
echo "Tool count: $TOOL_COUNT (expected 112)"
if [ "$TOOL_COUNT" -ne 112 ]; then
    echo "  ✗ Expected 112 tools, got $TOOL_COUNT"
    exit 1
fi
